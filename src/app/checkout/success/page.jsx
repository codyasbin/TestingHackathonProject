    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md p-8 text-center bg-white shadow-xl">
          ...
          <p className="text-gray-600 mb-6">Your booking is confirmed. We've sent a confirmation email with all the details.</p>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-6 flex items-start gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-medium text-emerald-900 mb-1">Environmental Impact</p>
              <p className="text-xs text-emerald-800">You've saved approximately 0.15 tons of CO₂ by repairing instead of replacing! 🌍</p>
            </div>
          </div>
