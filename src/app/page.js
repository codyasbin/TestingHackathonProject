              ...
              <DropdownMenuTrigger asChild>
                <button className="focus:outline-none focus:ring-2 focus:ring-green-500 rounded-full">
                  <Avatar className="w-10 h-10 cursor-pointer hover:ring-2 hover:ring-green-400 transition-all">
                    <AvatarImage src={"/"} />
                    <AvatarFallback className="bg-green-600 text-white font-semibold">{"u"}</AvatarFallback>
                  </Avatar>
                </button>
              </DropdownMenuTrigger>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuLabel>
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="inline-block mt-1 px-2 py-0.5 text-xs font-medium bg-green-100 text-green-800 rounded-full">{"user"}</span>
                  </div>
                </DropdownMenuLabel>
                ...
                <DropdownMenuItem onClick={() => router.push("/rewards")} className="cursor-pointer">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
