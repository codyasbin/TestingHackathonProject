      ...
      <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/5 to-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Discover local service providers committed to sustainability. From gardening to energy efficiency, build a
            greener lifestyle with trusted professionals.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Explore our range of eco-friendly services designed to help you live sustainably.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { number: "1", title: "Browse", description: "Explore services in your area" },
              { number: "2", title: "Compare", description: "Read ratings and reviews" },
              { number: "3", title: "Book", description: "Schedule with your chosen provider" },
              { number: "4", title: "Enjoy", description: "Reduce your carbon footprint" },
            ].map((step, index) => (
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-secondary/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "Green Thumb Landscaping", rating: 4.9, reviews: 128, specialty: "Eco Gardening" },
              { name: "Sunny Solutions", rating: 4.8, reviews: 95, specialty: "Solar Energy" },
              { name: "Waste Wise Co.", rating: 4.7, reviews: 112, specialty: "Waste Management" },
            ].map((provider, index) => (
